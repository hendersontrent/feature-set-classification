...
p <- clusters %>%
  ...
  geom_rect(aes(xmin = 7.5, xmax = 8.5, ymin = 93.5, ymax = 99.5), fill = NA, colour = "black", size = 1) + # Quantiles > mean
  geom_rect(aes(xmin = 0.5, xmax = 6.5, ymin = 0.5, ymax = 93.5), fill = NA, colour = "black", size = 1) + # Big feature set box
  geom_rect(aes(xmin = 2.5, xmax = 3.5, ymin = 72.5, ymax = 73.5), fill = NA, colour = "black", size = 1) + # TSFEL standout PigCVP
  geom_rect(aes(xmin = 4.5, xmax = 5.5, ymin = 31.5, ymax = 32.5), fill = NA, colour = "black", size = 1) + # Kats standout Yoga
  geom_rect(aes(xmin = 0.5, xmax = 1.5, ymin = 74.5, ymax = 75.5), fill = NA, colour = "black", size = 1) + # tsfresh standout InsectWingbeatSound
  labs(x = "Feature set",
       y = "Problem",
